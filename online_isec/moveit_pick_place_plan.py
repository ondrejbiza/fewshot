...
def main(args):
    ...
    if args.multiple_waypoints:
        ...
        while True:
            if i == 1:
                # Hack for mug tree. Finish the mug placing motion without collision checking.
                # Because the handle of the mug is too close to the tree and ROS collisions are hard to work with.
