...
num_surface_samples = 2000  # number of points to use for surface sampling
...
def mug_tests(mug_files, sampling_method="mesh"):
    ...
    for i in range(len(test_mugs)):
        ...
        # new_target_mesh = trimesh.intersections.slice_mesh_plane(target_mesh, (0,0,1), target_mesh.centroid)
        # points = new_target_mesh.vertices.T
...
if __name__ == "__main__":
    ...
    # mug_tests( ['m1.obj', 'm2.obj', 'm3.obj', 'm4.obj', 'm5.obj', 'm6.obj'], 'surface')
