...
from src.GraspClassifier import GraspClassifier
import src.grasp_pose_generator as gpg
...
def test(pcl, num_samples):
    visualize = False

    #test_cloud_file = "./pointclouds/"+task+".ply"
    test_cloud_with_normals = pcl #o3d.io.read_point_cloud(test_cloud_file)
    ...
    gs = GraspSelector(np.eye(4), test_cloud_with_normals)
