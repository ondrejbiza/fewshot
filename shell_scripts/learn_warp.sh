...
python -m scripts.learn_warp data/230315_ndf_mugs_scale_pca_8_dim_alp_0_01.pkl ndf_mugs $tmp_args
...
python -m scripts.learn_warp data/230315_simple_trees_scale_pca_8_dim_alp_0_01.pkl simples_trees $tmp_args
