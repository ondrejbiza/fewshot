...
--n_demos 1 \
--new_descriptors \
--parent_load_pose_type random_upright --child_load_pose_type random_upright &> /tmp/rndf_mug_on_tree_upright_1_demo.txt
cp /tmp/rndf_mug_on_tree_upright_1_demo.txt outputs/
