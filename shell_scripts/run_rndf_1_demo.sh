...
--n_demos 1 \
--new_descriptors \
--parent_load_pose_type random_upright --child_load_pose_type random_upright &> /rndf_mug_on_tree_upright_1_demo.txt
cat /rndf_mug_on_tree_upright_1_demo.txt
# cp /rndf_mug_on_tree_upright_1_demo.txt outputs/
...
# --n_demos 1 \
# --new_descriptors \
# --parent_load_pose_type random_upright --child_load_pose_type random_upright &> /tmp/rndf_bottle_in_box_upright_1_demo.txt
...
# --n_demos 1 \
# --new_descriptors \
# --parent_load_pose_type random_upright --child_load_pose_type random_upright &> /tmp/rndf_bowl_on_mug_upright_1_demo.txt
...
# --n_demos 1 \
# --new_descriptors \
# --parent_load_pose_type random_upright --child_load_pose_type any_pose &> /tmp/rndf_mug_on_tree_any_1_demo.txt
...
# --n_demos 1 \
# --new_descriptors \
# --parent_load_pose_type random_upright --child_load_pose_type any_pose &> /tmp/rndf_bottle_in_box_any_1_demo.txt
...
# --n_demos 1 \
# --new_descriptors \
# --parent_load_pose_type random_upright --child_load_pose_type any_pose &> /tmp/rndf_bowl_on_mug_any_1_demo.txt
