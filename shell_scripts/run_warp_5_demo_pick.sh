...
CUDA_VISIBLE_DEVICES=$GPU \
    ...
    --demo_selection \
    --n_demos 5 \
    --parent_load_pose_type random_upright --child_load_pose_type random_upright &> outputs/bowl_on_mug_upright_5_demo_pick.txt
...
CUDA_VISIBLE_DEVICES=$GPU \
    ...
    --demo_selection \
    --n_demos 5 \
    --parent_load_pose_type random_upright --child_load_pose_type any_pose &> outputs/bowl_on_mug_any_5_demo_pick.txt
...
CUDA_VISIBLE_DEVICES=$GPU \
    ...
    --demo_selection \
    --n_demos 5 \
    --parent_load_pose_type random_upright --child_load_pose_type random_upright &> outputs/mug_on_tree_upright_5_demo_pick.txt
...
CUDA_VISIBLE_DEVICES=$GPU \
    ...
    --demo_selection \
    --n_demos 5 \
    --parent_load_pose_type random_upright --child_load_pose_type any_pose &> outputs/mug_on_tree_any_5_demo_pick.txt
...
CUDA_VISIBLE_DEVICES=$GPU \
    ...
    --demo_selection \
    --n_demos 5 \
    --parent_load_pose_type random_upright --child_load_pose_type random_upright &> outputs/bottle_in_box_upright_5_demo_pick.txt
...
CUDA_VISIBLE_DEVICES=$GPU \
    ...
    --demo_selection \
    --n_demos 5 \
    --parent_load_pose_type random_upright --child_load_pose_type any_pose &> outputs/bottle_in_box_any_5_demo_pick.txt
