...
viz_utils.show_pcds_plotly({"mug": whole_mug_pcl}, axis_visible=False).show()
exit(0)
...
utils.generate_slider_viz_by_parts(
    part_warps, {'cup': mug_part_pcls['cup'], 'handle': mug_part_pcls['handle']}, 
    {'cup': mug_part_canon_models['cup'].canonical_pcl, 'handle': mug_part_canon_models['handle']},  
    use_latents=True, models=mug_part_canon_models, 
    static_masks=None, tf_masks=None, generate_animation=True, 
    experiment_id=f'scripts/paper_figure_scripts/by_parts_mug_warping'
).show()
