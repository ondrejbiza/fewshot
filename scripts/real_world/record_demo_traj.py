...
def main(args):
    ...
    if args.task == "mug_tree":
        ...
        source_pcd, target_pcd = perception.brush_bowl_segmentation(cloud, platform_pcd=platform_pcd)  # TODO: brush-box segmentation
        ...
        source_pcd, target_pcd = perception.brush_box_segementation(cloud, platform_pcd=platform_pcd)  # TODO: brush-box segmentation
    else:
